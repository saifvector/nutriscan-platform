      ...
      <div style={{ maxWidth: 840, margin: '60px auto', padding: '0 24px' }}>
        ...
        >
          ...
          <h2 style={{
            ...
            No nutrient interaction graph available.
          </h2>
          ...
          <p style={{
            ...
            The nutrient interaction graph requires an active assessment to project individual micronutrient interactions, absorption synergies, and metabolic competitions. Complete an assessment to explore your personalized metabolic network.
          </p>
