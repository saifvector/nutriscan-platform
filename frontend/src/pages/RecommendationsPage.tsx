    ...
    return (
      <>
        <AssessmentRequiredState
          ...
          description="Personalized food recommendations, synergistic nutrient pairings, and therapeutic recovery roadmaps require an active clinical assessment to match your metabolic needs. Complete an assessment to generate clinical dietary interventions."
