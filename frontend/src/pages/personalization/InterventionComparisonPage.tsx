    ...
    return (
      <>
        <AssessmentRequiredState
          ...
          description="Multi-strategy intervention comparisons, unified clinical scoring, and cost-benefit trade-offs require an active patient assessment session. Complete an assessment to evaluate intervention options."
