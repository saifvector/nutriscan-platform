    ...
    return (
      <>
        <AssessmentRequiredState
          ...
          description="Personalized multi-day meal planning, nutrient targets, and automated grocery lists are generated from your clinical assessment findings. Complete an assessment to generate your personalized meal schedule."
